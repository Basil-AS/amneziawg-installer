...
class BotTests(unittest.TestCase):
    ...
    def test_client_callbacks_fit_telegram_limit(self):
        ...
        self.assertTrue({"client:toggle:0123456789", "client:p2p-toggle:0123456789", "client:ports-toggle:0123456789", "client:access-link:0123456789", "client:remove:0123456789"}.issubset({button["callback_data"] for row in buttons for button in row}))

...
- AdGuard Home: добавлен loopback-only API-прокси для статуса, статистики, query log и управления URL-фильтрами; Telegram-администратор получил просмотр, обновление, добавление и удаление списков.

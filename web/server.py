...
def server_info_payload():
    ...
    return {
        ...
        "protocol_version": cfg.get("AWG_PROTOCOL_VERSION") or "3.1",
        "protocol_profile": "present" if (cfg.get("AWG_PROTOCOL_VERSION") or "3.1") != "3.1" or (AWG_DIR / "awg31-profile.json").is_file() else "missing",
    }
